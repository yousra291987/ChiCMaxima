...
if(dim(one)[2]!=11) {
	stop("Wrong ibed format for replicate 1 - ID_Bait, chr_Bait, start_Bait, end_Bait, Bait_name, ID_OE, chr_OE, start_OE, end_OE, OE_name, N\n")
}
two=read.table(two.file,header=TRUE)
if(dim(one)[2]!=11) {
	stop("Wrong ibed format for replicate 2- ID_Bait, chr_Bait, start_Bait, end_Bait, Bait_name, ID_OE, chr_OE, start_OE, end_OE, OE_name, N\n")
}
